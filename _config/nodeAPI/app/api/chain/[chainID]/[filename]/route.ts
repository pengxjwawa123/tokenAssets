...
async function resolveNotFound(request: Request): Promise<Response> {
	...
	if (fallback === 'true') {
		const baseURI = 'https://raw.githubusercontent.com/pengxjwawa123/tokenAssets/main/_config/nodeAPI/public';
...
export async function GET(request: Request, context: TContext): Promise<Response> {
	...
	const baseURI = 'https://raw.githubusercontent.com/pengxjwawa123/tokenAssets/main';
